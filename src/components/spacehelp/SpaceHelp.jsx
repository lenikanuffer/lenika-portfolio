...
function SpaceHelp () {
   ...
   <main className="hero-landing flex flex-col">
        ...
        <p className="landing-bio main-font mx-10 pt-3 w-3/5 text-justify	">
         SpaceHelp is a small Author's ice cream factory located in Pichilemu, Chile. They offer original flavours inspired by regional products, and that adapt to a variaty of clients nutritional needs. They have succeed to partner with several local business who distribute their products.
         
        </p>
        <p className="mx-10 mb-10 pt-3">Roles: User Research, UX Designer, Frontend Devloper</p>
   </main>
    <section className="flex flex-col">
        <div className="content-box mx-10 my-5">
            <p>Problem</p>
            <p className="main-font w-2/3">SpaceHelp is a small business with online presence only trough social media (Instagram). They offer their products to two types of clients: people who visit their café, and distributors. For these reasons, their needs are: 
