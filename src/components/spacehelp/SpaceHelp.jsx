   ...
   <main className="hero-landing flex flex-col">
    ...
    <section className="flex flex-col">
        <div className="content-box mx-10 my-5">
            ...
            <p className="main-font w-2/3 text-justify">Many people approach decluttering as a one-time big task, making this process overwhelming. Space Help was created to help users change this idea, and to think of decluttering as a process, integrating it into their habits. Inspired by different methods, such as the '30 day minimalism challenge', Space Help encourages users to tackle their space into small areas, completing daily decluttering challenges while tracking their total progress.
        ...
        <div className="content-box mx-10 my-5 flex flex-col ">
           ...
           <div className="main-font w-2/3 text-justify">
           ...
           <div className="inner-imgs-container ml-10 flex flex-col gap-10 my-10 ">
            <div className="landing-page-imgs flex flex-col gap-4">
                ...
                <img src={SpaceLanding} alt="" className="rounded-xl fig" />
                <p className="icon-description pt-4">Landing page with 15 challenges</p>
                </div>
                <div className="single-screen">
                <img src={SingleChallenge} alt="" className="rounded-xl  fig"/> 
                <p className="icon-description pt-4">Single challenge and different states</p>
                </div>
                <div className="single-screen">
                <img src={Progress} alt="" className="rounded-xl fig "/>
        ...
        <div className="content-box mx-10 my-5 ">
            ...
            <div>
                <img src={SpaceConcept} alt="" className="h-72 rounded-xl pt-4 " /> 
                <p className="icon-description pt-4">Color palette inspired in various galaxy illustrations and images</p>
            </div>
            <div className="flex  gap-5 pt-4">
                <div className="flex flex-col">
            <div className="flex">
            <img src={ChallengeInitial} alt="" className="h-36 " />
            <img src={ChallengeCompleted} alt="" className="h-36 " />
            </div>
            ...
            <img src={ItemInitial} alt="" className="h-36"/>
            <img src={ItemRecycle} alt="" className="h-36"/>
            <img src={ItemDonate} alt="" className="h-36"/>
            <img src={ItemSell} alt="" className="h-36"/>
            </div>
