   ...
   <main className="hero-landing flex flex-col">
    ...
    <section className="flex flex-col">
        <div className="content-box mx-10 my-5">
            ...
            <p className="main-font w-2/3 text-justify">Buenamano is a small business with online presence trough social media (Instagram). They offer their products to two types of clients: people who visit their café, and distributors. We identified as main needs for this customer: 
        ...
        <div className="content-box mx-10 my-5 flex flex-col ">
           ...
           <div className="inner-imgs-container ml-10 flex flex-col gap-10 my-10 ">
            <div className="landing-page-imgs flex flex-col gap-4">
                ...
                <img src={HeroScreen} alt="" className="rounded-xl fig" />
                <img src={LocalsScreen} alt="" className="rounded-xl  fig"/>
                <img src={AboutScreen} alt="" className="rounded-xl fig "/>
                </div>
            ...
            <div className=" flex gap-5 ">
                <div className="product-card-container flex flex-col">
                    <div className="flex gap-5">
            <img src={ProductCard} alt="" className="rounded-xl mb-5 fig " />
            ...
            <div className="contact-container flex flex-col gap-5">
                <img src={ContactForm} alt="" className="rounded-xl fig"/>
        ...
        <div className="content-box mx-10 my-5 ">
            ...
            <div>
            <img src={Desktop} alt="" className="fig rounded-xl"/>
